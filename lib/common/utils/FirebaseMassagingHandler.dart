...
class FirebaseMessagingHandler {
  ...
  static Future<void> firebaseMessagingBackground(
    ...
    Logger.write("message data: ${message?.data}");
    Logger.write("message data: $message");
    Logger.write("message data: ${message?.notification}");
    ...
    if (message != null) {
      if (message.data["call_type"] != null) {
        ...
        if (message.data["call_type"] == "voice" ||
          ...
          Logger.write(jsonEncode(data));
          var prefs0 = await SharedPreferences.getInstance();
          await prefs0.setString("CallVocieOrVideo", jsonEncode(data));
        }
      }
    }
  }
